...
namespace jrc
{
	struct Buff
	{
		...
		static constexpr size_t NUM_FIRST_BUFFS = 13;
		static constexpr Stat FIRST_BUFFS[NUM_FIRST_BUFFS] =
		{
		...
		static constexpr size_t NUM_SECOND_BUFFS = 54;
		static constexpr Stat SECOND_BUFFS[NUM_SECOND_BUFFS] =
		{
			...
			SPARK, FINALATTACK, WATK, WDEF, MATK, MDEF, ACC, AVOID,
			SHOWDASH, SPEED, JUMP, MAGIC_GUARD, DARKSIGHT, BOOSTER, POWERGUARD,
