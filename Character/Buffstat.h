...
namespace Character
{
	...
	const size_t FIRST_BUFFS = 13;
	const size_t SECOND_BUFFS = 54;

	const Buffstat firstbuffs[FIRST_BUFFS] = 
	{
	...
	const Buffstat secondbuffs[SECOND_BUFFS] =
	{
