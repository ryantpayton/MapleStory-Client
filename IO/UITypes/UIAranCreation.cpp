...
namespace jrc
{
	UIAranCreation::UIAranCreation(uint8_t selected) : UIElement(Point<int16_t>(0, 0), Point<int16_t>(800, 600)), selected_class(selected)
	{
		gender = false;
		charSet = false;
		named = false;
	...
	void UIAranCreation::send_key(int32_t keycode, bool pressed)
	{
		if (pressed)
		{
